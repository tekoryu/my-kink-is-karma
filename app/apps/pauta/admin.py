...
class ProposicaoAdmin(admin.ModelAdmin):
    ...
    list_display = ['identificador_completo', 'tema', 'autor', 'iniciadora', 'revisora', 'current_house', 'tem_dados_api', 'ultima_sincronizacao']
    list_filter = ['tema', 'tipo', 'ano', 'iniciadora', 'revisora', 'current_house', 'ultima_sincronizacao', 'created_at', 'updated_at']
    ...
    fieldsets = (
        ...
        ('Dados das APIs', {
            'fields': ('sf_id', 'cd_id', 'autor', 'data_apresentacao', 'iniciadora', 'revisora', 'ementa', 'current_house')
        }),
        ('Sincronização', {
